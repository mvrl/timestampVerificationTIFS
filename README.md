...
>
> DOI: [10.1109/TIFS.2022.3159154](https://doi.org/10.1109/TIFS.2022.3159154)

If you use or build upon this code, please cite the publication above. For questions about the method or evaluation, feel free to reach out by email.
...
The **dataset** can be found at the [CVT website](https://tsalem.github.io/DynamicMaps/). The tampered timestamps are included in the `dataset` folder.
...
Use the **Project Structure** below to help you.
...
- `datasets`: Example files of a dataLoader, dummy directory structure for the dataset, and information about the Cross-Camera organization of CVT
- `paper_evaluation`: Code and Jupyter notebooks for the experiments presented in the paper
- `training_testing`: Example files to train and test the models (if you want to build on top of this work, this is the place to start)
